...
/* Transparente fixierte Navbar bei Scrollen */
$().ready(function(){
    $(window).on('scroll', gsdk.checkScrollForTransparentNavbar);
});
/* Counter Vorteile */
jQuery(document).ready(function($) {
    $('.header-facts li span').counterUp({
        delay: 1.2,
         time: 600
    });
});
/* Parallax */
$.stellar();
/* Ausblenden Headertext bei Scrollen */
var fadeStart=50 
    ,fadeUntil=200 
    ,fading = $('.header-title')
;
...
$(window).bind('scroll', function(){
    ...
    if( offset<=fadeStart1 ){
        opacity=1;
    }else if( offset<=fadeUntil1 ){
        opacity=1-offset/fadeUntil1;
    }
