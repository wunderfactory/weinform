<nav id="dashboard_area_nav" class="navbar navbar-default">
  <div class="container navbar_container">
    <ul class="nav navbar-nav">
        ...
        <li><a class="{{ Request::segment(array_search('users', Request::segments())+2) == 'shipments' ? 'active_topbar':''}}" href="{{ route('users.shipments.index', [Auth::user()]) }}">Deine Sendungen</a></li>
