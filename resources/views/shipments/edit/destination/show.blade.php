<div class="form-group">
    ...
    <div class="input-group">
        ...
        <input id="destination-fake-input" value="{{ $destination->title }}" class="form-control" type="text" placeholder="{{ $destination->title }}" readonly>
        <span class="input-group-btn">
            <a id="origin-popover-btn" href="#" type="button" class="btn btn-behance" data-html="true" data-toggle="popover" title="{{ $destination->title }}" data-placement="bottom" data-content="<address>
